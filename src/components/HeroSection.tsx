...
const HeroSection = () => {
  ...
  return <section className="relative py-20 bg-gradient-to-br from-automator-50 via-automator-100 to-blue-100 dark:from-automator-950 dark:via-automator-900 dark:to-blue-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <Button onClick={handleCTA} size="lg" className="bg-automator-600 hover:bg-automator-700 text-white">
          {t('hero.cta')}
        </Button>
      </div>
